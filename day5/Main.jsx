    ...
    return(
       ...
       <div>
        <div className="mainadmin">
            ...
            <br></br>
            <p style={{fontSize:"24px",fontFamily:"inherit",color:"black",marginLeft:"32%"}}>ADMIN</p>
        </div>
        <div>
            ...
            <br></br>
            <p style={{fontSize:"24px",fontFamily:"inherit",color:"black",marginLeft:"62%",marginTop:"-5%"}}>USER</p>
